...
class Ginstall:
    ...
    # choosing disk part.
        ...
        for line in p.stdout:
            ...
            print ' %s' % line.rstrip()
            print '-----------------------------------'
        DISK = raw_input("\n\n Select a disk to install DesktopBSD: ")
    ...
    # Second option slice partition With auto labels.
                ...
                while True:
                    ...
                    if DPART == "d":
                        ...
                        while True:
                            SLICE = raw_input("Select the slice you wish to install DesktopBSD to (s1' s2' s3 or s4): ")
    ...
    # Starting the installation.
        call('clear', shell=True)
        GINSTALL = raw_input("Ready To install DesktopBSD now?(yes or no): ")
        if GINSTALL == "yes":
            print "install"
